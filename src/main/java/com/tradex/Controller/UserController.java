...
import com.tradex.request.UpdatePasswordRequest;
...
public class UserController {
    ...
    public ResponseEntity<User> enabledTwoFactorAuthentication(
        ...
        VerificationCode verificationCode = verificationService.getVerificationCodeByUser(user.getId());
        ...
        if (isVerified) {
            User updatedUser = userService.enabledTwoFactorAuthentication(verificationCode.getVerificationType(),
                    sendTo,user);
            verificationService.deleteVerificationCodeById(verificationCode);
