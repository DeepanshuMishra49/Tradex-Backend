...
import com.tradex.Repositary.CoinRepositary;
...
public class CoinServiceImpl implements CoinService{
    ...
    @Autowired
    private CoinRepositary coinRepositary;
...
//        coinRepository.save(coins);
        ...
        coinRepositary.save(coin);
        return response.getBody();
    }

    @Override
    public Coin findById(String coinId) throws Exception {
        Optional<Coin> optionalCoin = coinRepositary.findById(coinId);
