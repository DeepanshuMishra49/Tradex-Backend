...
import com.tradex.Repositary.AssetsRepositary;
...
public class AssetServiceImpl implements  AssetService {
    private  AssetsRepositary assetRepository;

    @Autowired
    public void AssetServiceImplementation(AssetsRepositary assetRepository) {
